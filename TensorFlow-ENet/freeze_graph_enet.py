...
def run_main():
  ...
  parser.add_argument(
      "--input_graph",
      type=str,
      default="/mnt/mdisk/lwt/ljm/TensorFlow-ENet-master-original/logoriginal/original/graph.pbtxt",#D:\\TensorFlow-ENet-master\\log\\original\\
  ...
  parser.add_argument(
      "--input_checkpoint",
      type=str,
      default="/mnt/mdisk/lwt/ljm/TensorFlow-ENet-master-original/logoriginal/original/model.ckpt-21600",#/mnt/mdisk/lwt/ljm/TensorFlow-ENet-master/log/original/model.ckpt-0#D:\\TensorFlow-ENet-master\\log\\original\\model.ckpt-0
  ...
  parser.add_argument(
      "--output_graph",
      type=str,
      default="/mnt/mdisk/lwt/ljm/TensorFlow-ENet-master-original/logoriginal/original/enet.pb",#D:\\TensorFlow-ENet-master\\checkpoint\\
  ...
  parser.add_argument(
      "--output_node_names",
      type=str,
      default="Reshape_2",#Images/Validation_segmentation_output #Reshape_6
