...
#image_dir = "./datasetoriginal/trainannot"
image_files = [os.path.join(image_dir, file) for file in os.listdir(image_dir) if file.endswith('.png')]

def ENet_weighing(image_files=image_files, num_classes=5):#12
    '''
...
def median_frequency_balancing(image_files=image_files, num_classes=5):#12
    '''
...
if __name__ == "__main__":
    median_frequency_balancing(image_files, num_classes=5)#12
    ENet_weighing(image_files, num_classes=5)#12