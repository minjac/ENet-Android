...
#flags.DEFINE_string('dataset_dir', './datasetoriginal', 'The dataset directory to find the train, validation and test images.')
flags.DEFINE_string('logdir', './log/original', 'The log directory to save your checkpoint and event files.')
#flags.DEFINE_string('logdir', './logoriginal/original', 'The log directory to save your checkpoint and event files.')
...
#flags.DEFINE_integer('num_classes', 12, 'The number of classes to predict.')#12
flags.DEFINE_integer('batch_size', 10, 'The batch_size for training.')
flags.DEFINE_integer('eval_batch_size', 1, 'The batch size used for validation.')#25
...
flags.DEFINE_integer('image_height', 360, "The input height of the images.")#360
flags.DEFINE_integer('image_width', 480, "The input width of the images.")#480
flags.DEFINE_integer('num_epochs', 1000, "The number of epochs to train your model.")#100
...
#flags.DEFINE_float('initial_learning_rate', 5e-4, 'The initial learning rate for your training.')
flags.DEFINE_string('weighting', "ENET", 'Choice of Median Frequency Balancing or the custom ENet class weights.')#ENET
