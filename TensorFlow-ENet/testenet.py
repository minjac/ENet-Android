...
#Directories
flags.DEFINE_string('dataset_dir', '/mnt/mdisk/lwt/ljm/TensorFlow-ENet-master/dataset', 'The dataset directory to find the train, validation and test images.')
flags.DEFINE_string('checkpoint_dir', '/mnt/mdisk/lwt/ljm/TensorFlow-ENet-master/checkpoint', 'The checkpoint directory to restore your model')
flags.DEFINE_string('logdir', '/mnt/mdisk/lwt/ljm/TensorFlow-ENet-master/log', 'The log directory for event files created during test evaluation.')
